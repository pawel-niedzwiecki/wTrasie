...
export async function clientGetArticlesListQuery({ page, pageSize = 12, type = ['service', 'article'], idTag }: { page: number; pageSize?: number; type?: Array<string>; idTag?: number }) {
